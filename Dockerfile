...
RUN wget -q https://dl.google.com/dl/cloudsdk/channels/rapid/downloads/google-cloud-sdk-125.0.0-linux-x86_64.tar.gz
RUN tar -xzf google-cloud-sdk-125.0.0-linux-x86_64.tar.gz
